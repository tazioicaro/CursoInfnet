...
<legend>${titulo}</legend>
		...
		<tr style=<%=style %>>
			...
			<td><a href='Controlador?opc=editarEscola&codigo=<%=samba.getId()%>'>Atualizar</a></td>
			<td><a href='Controlador?opc=excluirEscola&codigo=<%=samba.getId()%>'>Excluir</a></td>
		</tr>
		<%} %>
		</table>
		<br><hr>
		<input type="submit" value="Cadastrar escola" onclick="location.href='Controlador?opc=editarEscola'">
		</div>
		</fieldset>
